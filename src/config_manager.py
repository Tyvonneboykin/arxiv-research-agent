...
class ConfigManager:
    ...
    def get_performance_config(self) -> PerformanceConfig:
        ...
        performance_data = self.get('performance', {})
        cache_data = performance_data.get('cache', {})
        concurrency = performance_data.get('concurrency', {})
        ...
        return PerformanceConfig(
            cache=cache_config,
            max_concurrent_analyses=concurrency.get('max_concurrent_analyses', 3),
            max_concurrent_fetches=concurrency.get('max_concurrent_fetches', 5)
        )
